...
const SvgComponent:React.FC<{color:string}> = ({color}) => {
  return(
    <svg viewBox="74.26 77.635 55.132 54" width={45} height={45} className={clsx('mt-1',color)}>
  ...
  return(
    <UnstyledLink href='/'>
      <div className="flex align-baseline justify-start ">
        ...
        <Accent className="p-0 mt-3 text-3xl tracking-wide">PersonalFinance</Accent>
      </div>
      {withText && <p className={clsx('tracking-widest text-lg pl-1 font-bold')}>Track your Cash Flow</p>}
    </UnstyledLink>
  )
}
