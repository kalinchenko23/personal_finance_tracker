...
const SvgComponent = () => (
  <svg viewBox="74.26 77.635 55.132 54" width={35} height={35} className='mt-1'>
  ...
  return(
    <UnstyledLink href='/'>
      <div className="flex align-baseline justify-start ">
        <SvgComponent /> 
        <span className="p-0 mt-1 text-3xl tracking-wide">PersonalFinance</span>
      </div>
      <div className='tracking-wide pl-1'>Track your Cash Flow</div>
    </UnstyledLink>
  )
}
