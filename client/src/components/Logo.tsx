...
const SvgComponent:React.FC<{color:string}> = ({color}) => {
  return(
    <svg 
      ...
      className={clsx(
        'mt-1',color, ' hidden sm:block w-[35px] h-[35px] md:w-[45px] md:h-[45px]'
      )}>
  ...
  return(
    <UnstyledLink href='/'>
      <div className="flex align-baseline justify-start ">
        ...
        <Accent 
          className="text-2xl p-0 mt-2 sm:mt-3 sm:text-3xl md:tracking-wide"
        >
          PersonalFinance
        </Accent>
      </div>
      {withText && <p className={clsx('sm:tracking-widest text-base sm:text-2xl pl-1 font-bold')}>Track your Cash Flow</p>}
    </UnstyledLink>
  )
};
